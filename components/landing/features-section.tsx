...
const features = [
  {
    ...
    description: "Describe your goal in plain English. XenoCRM finds the audience, generates personalized messages, recommends the best channel, and launches the campaign with a single approval.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Smart Segmentation",
    description: "Build audiences manually or let AI generate filters instantly using customer spend, recency, city, tags, and order history.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Channel Delivery",
    description: "Launch campaigns across WhatsApp, Email, SMS, and RCS with realistic delivery tracking, open rates, and callback handling.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Real-Time Analytics",
    description: "Monitor deliveries, opens, clicks, channel performance, and campaign comparisons using live database data.",
    visual: "security",
  },
];
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 py-12 lg:py-20 border-b border-black/10">
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-48 h-40 text-black">
