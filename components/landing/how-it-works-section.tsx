...
const steps = [
  {
    ...
    description: "Describe your campaign goal in plain English. XenoCRM understands your intent and plans the entire workflow.",
    code: `import { xeno } from '@xeno/core'
...
xeno.connect({
  ...
  },
  {
    ...
    description: "AI builds the audience, generates personalized messages, and recommends the best channel. You stay in control.",
    code: `xeno.workflow('process', {
  trigger: 'event',
  actions: [
    'engage',
    'campaign', 
  ...
  },
  {
    ...
    description: "Campaigns are dispatched instantly across channels while deliveries, opens, and clicks update in real time.",
    code: `xeno.deploy({
  target: 'production',
  regions: 'auto'
})
...
export function HowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="relative py-24 lg:py-32 bg-neutral-950 text-white overflow-hidden"
    >
